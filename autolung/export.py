...
def write_output(data_list, output_path):
    ...
    with pd.ExcelWriter(os.path.join(output_path, "Lung_Data_{}.xlsx".format(timestr)), engine='xlsxwriter') as writer:
        ...
        s1.write_comment('C1', 'Location - derived from the decond field of the FileName')
        ...
        s1.write_comment('M1', 'Sdev Area - The standard deviation of the mean area of the airspaces in the image given in square micrometers')
        ...
        s2.write_comment('C1', 'Location - derived from the decond field of the FileName')
        ...
        s2.write_comment('M1', 'Sdev Area - The standard deviation of the mean area of the airspaces in the image given in square micrometers')
