...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.preview_label.setGeometry(QtCore.QRect(30, 240, 331, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.preview_label.setFont(font)
        self.preview_label.setObjectName("preview_label")
        self.yes_radioButton = QtWidgets.QRadioButton(self.centralwidget)
        self.yes_radioButton.setGeometry(QtCore.QRect(380, 250, 41, 17))
        ...
        self.run_button.setGeometry(QtCore.QRect(30, 320, 331, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.preview_label.setText(_translate("MainWindow", "Would you like to preview the image processing steps?"))
